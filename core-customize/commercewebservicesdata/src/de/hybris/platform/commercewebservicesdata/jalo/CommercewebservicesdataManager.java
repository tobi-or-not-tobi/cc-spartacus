 ...
 */
package de.hybris.platform.commercewebservicesdata.jalo;
...
import de.hybris.platform.commercewebservicesdata.constants.CommercewebservicesdataConstants;



/**
 * This is the extension manager of the commercewebservicesdata extension.
 */
public class CommercewebservicesdataManager extends GeneratedCommercewebservicesdataManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CommercewebservicesdataManager.class.getName());
	 ...
	 */
	public CommercewebservicesdataManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CommercewebservicesdataManager called.");
		}
	}
	 ...
	 */
	public static CommercewebservicesdataManager getInstance()
	{
		return (CommercewebservicesdataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CommercewebservicesdataConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CommercewebservicesdataManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CommercewebservicesdataManager called, current tenant: " + getTenant().getTenantID());
		}
	}
